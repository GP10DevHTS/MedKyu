        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" wire:navigate href="{{ route('dashboard') }}">
                <svg width="60" height="40" viewBox="0 0 50 50">
                    ...
                    <path d="M16 0c8.837 0 16 7.163 16 16s-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0z" fill="#4F46E5" />
                    <path d="M21 13h-4V9h-2v4H11v2h4v4h2v-4h4v-2z" fill="white" />
                    <text x="50%" y="48" font-family="Arial, Helvetica, sans-serif" font-size="20" fill="#4F46E5"
                        text-anchor="middle">MedKyu</text>
                </svg>
            </a>

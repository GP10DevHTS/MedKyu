<div class=" mx-auto p-4 bg-gray-100 shadow-md rounded-lg h-full">
    <x-validation-errors />
    ...
    <form wire:submit.prevent="">
        ...
        <button wire:click="createAppointment"
            class="w-full mt-3  bg-blue-600 text-white font-bold py-3 px-4 rounded hover:bg-blue-700">Create Appointment</button>
    </form>
</div>

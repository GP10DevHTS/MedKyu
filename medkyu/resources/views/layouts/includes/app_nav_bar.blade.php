<div class="h-full px-3 pb-4 overflow-y-auto p-5 -mt-5 bg-gray-50 dark:bg-gray-800">
    <ul class="space-y-2 font-medium">
        ...
        @role('admin')
        <li>
            <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-200 dark:hover:bg-blue-700 group transition duration-200">
        ...
        {{-- User Management --}}
        <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-900 rounded-lg group hover:bg-blue-200 dark:text-white dark:hover:bg-blue-700 transition duration-200" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                <li class="ms-2">
                    <a href="{{ route('users') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-100 dark:text-white dark:hover:bg-blue-600">
                        <span class="ml-3">Patients</span>
                    </a>
                </li>
                <li class="ms-2">
                    <a href="{{ route('users.doctor') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-100 dark:text-white dark:hover:bg-blue-600">
        ...
        {{-- Access Control --}}
        <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-900 rounded-lg group hover:bg-blue-200 dark:text-white dark:hover:bg-blue-700 transition duration-200" aria-controls="userManagementDropDown" data-collapse-toggle="userManagementDropDown">
                <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <ul id="userManagementDropDown" class="hidden py-2 space-y-2">
                <li class="ms-2">
                    <a href="{{ route('roles.list') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-100 dark:text-white dark:hover:bg-blue-600">
                        <span class="ml-3">Roles</span>
                    </a>
                </li>
                <li class="ms-2">
                    <a href="{{ route('permissions.list') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-100 dark:text-white dark:hover:bg-blue-600">
        ...
        {{-- Inbox --}}
        <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-200 dark:hover:bg-blue-700 group transition duration-200">
                <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        {{-- Logout --}}
        <li>
            <form class="flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-blue-200 dark:hover:bg-blue-700 group transition duration-200" method="POST" action="{{ route('logout') }}" x-data>
                @csrf
                <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">

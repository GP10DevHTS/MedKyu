                            ...
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr class="border-b dark:border-gray-700 w-full" >
                                   <th scope="col" class="px-4 py-3">Patient Details</th>
                                    ...
                                    <th scope="col" class="px-4 py-3">special_needs</th>
                                        ...
                                        center space-x-3">
                                            <div class="avatar">
                                                <div class="flex items-center ">
                                                    <img class="w-10 h-10 rounded-full" src="{{$history->student->profile_photo_url}}" alt="{{$history->student->name}}">                                                {{ $history->student->name }}
                                            </div>
                                      {{ $history->student->email }}
                                            </div>
                                        </div>
                                        
                                    </td>
                                    {{-- <td class="px-8 py-3 md:px-12 md:py-4">{{ $history->blood_type }}</td> --}}
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $history->allergies }}</td>
                                    <td class="ppx-4 py-2 font-medium text-gray-900 dark:text-white">{{ $history->special_needs }}</td>
                                    {{-- <td class="px-4 py-2 font-medium text-gray-900  dark:text-white">{{ $history->created_at }}</td> --}}
                                    <td class="px-4 py-6 font-medium text-gray-900 dark:text-white flex items-center justify-end">
                                        <x-button wire:click="delete({{$history->id}})" class="py-2 px-4 text-sm text-white hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white mr-2">Delete</x-button>
